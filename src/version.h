...
#define FCEU_VERSION_PATCH  22
#define FCEU_VERSION_TWEAK  9
...
#define FCEU_VERSION_STRING "0.2.22.9"  FCEU_SUBVERSION_STRING FCEU_FEATURE_STRING FCEU_COMPILER
#define FCEU_DISPLAY_VERSION "v0.2.22.9"
