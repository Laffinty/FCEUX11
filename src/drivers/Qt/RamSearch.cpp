...
void RamSearchDialog_t::addCheatClicked(void)
{
	...
	FCEU_strlcpy( desc, sizeof(desc), "Quick Cheat Add");
...
void RamSearchDialog_t::addRamWatchClicked(void)
{
	...
	FCEU_strlcpy( desc, sizeof(desc), "Quick Watch Add");
...
void QRamSearchView::paintEvent(QPaintEvent *event)
{
	...
	FCEU_strlcpy(addrStr, sizeof(addrStr), "Address");
	FCEU_strlcpy(valStr, sizeof(valStr), "Value");
	FCEU_strlcpy(prevStr, sizeof(prevStr), "Previous");
	FCEU_strlcpy(chgStr, sizeof(chgStr), "Changes");
