...
fn main() {
    ...
    merge_headers(&crate_dir, &utils_out, &media_out, &formats_out, &debug_out);
...
fn merge_headers(crate_dir: &str, utils_path: &str, media_path: &str, formats_path: &str, debug_path: &str) {
