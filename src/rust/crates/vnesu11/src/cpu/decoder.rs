...
pub fn execute<BC: BusContext>(cpu: &mut CpuCore, op: u8, bus: &mut BC) {
    match op {
        ...
        // Canonical sizes (NESDev "CPU unofficial opcodes"):
        //   1-byte (implied, 0 operand bytes): 0x1A 0x3A 0x5A 0x7A 0xDA 0xFA
        //   2-byte (1 operand byte): 0x04 0x44 0x64 0x14 0x34 0x54 0x74 0xD4
        //     0xF4 0x80 0x82 0x89 0xC2 0xE2
        //   3-byte (2 operand bytes): 0x0C 0x1C 0x3C 0x5C 0x7C 0xDC 0xFC
        0x1A | 0x3A | 0x5A | 0x7A | 0xDA | 0xFA => {
            cpu.nop(); // 1-byte implied NOP
        }
