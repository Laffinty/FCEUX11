...
// R1.2 (docs/internal/refactor_plan_R1_R5_archive.md Â§Phase R1): the original loop was O(n^2) because
...
// R1.1 (docs/internal/refactor_plan_R1_R5_archive.md Â§Phase R1): the original 4 calls to
...
// R1.4 (docs/internal/refactor_plan_R1_R5_archive.md Â§Phase R1): Base64Table is now a C++20 constexpr
...
{
  // R1.5 (docs/internal/refactor_plan_R1_R5_archive.md Â§Phase R1): removed `using namespace std;` to
...
// R1.6 (docs/internal/refactor_plan_R1_R5_archive.md Â§Phase R1): the original loop was missing the
