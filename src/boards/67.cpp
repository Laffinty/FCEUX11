...
// v1.8 Masonry Phase E.2 step 9.3: MapperEntryRegister for mapper 67
// (SUNSOFT-FZII).  Cart subclass inherits MapperStrategyA (16-byte default body).
namespace fceu11 {
namespace {
static MapperEntryRegister kMapper67Register{
    MapperEntry{67, "SUNSOFT-FZII", &Mapper67_Init,
        [](Bus& bus) { return std::make_unique<Mapper67Cart>(bus); } }
};
}  // namespace
}  // namespace fceu11
