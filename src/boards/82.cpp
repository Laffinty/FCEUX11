...
// v1.8 Masonry Phase E.2 step 9.3: MapperEntryRegister for mapper 82
// (TAITO X1-017).  Cart subclass inherits MapperStrategyA (16-byte default body).
namespace fceu11 {
namespace {
static MapperEntryRegister kMapper82Register{
    MapperEntry{82, "TAITO X1-017", &Mapper82_Init,
        [](Bus& bus) { return std::make_unique<Mapper82Cart>(bus); } }
};
}  // namespace
}  // namespace fceu11
