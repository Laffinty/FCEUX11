...
// v1.8 Masonry Phase E.2 step 9.3: MapperEntryRegister for mapper 71
// (CAMERICA BF9093).  Cart subclass inherits MapperStrategyA (16-byte default body).
namespace fceu11 {
namespace {
static MapperEntryRegister kMapper71Register{
    MapperEntry{71, "CAMERICA BF9093", &Mapper71_Init,
        [](Bus& bus) { return std::make_unique<Mapper71Cart>(bus); } }
};
}  // namespace
}  // namespace fceu11
