...
// v1.8 Masonry Phase E.2 step 9.3: MapperEntryRegister for mapper 65
// (IREM-H3001).  Cart subclass inherits MapperStrategyA (16-byte default body).
namespace fceu11 {
namespace {
static MapperEntryRegister kMapper65Register{
    MapperEntry{65, "IREM-H3001", &Mapper65_Init,
        [](Bus& bus) { return std::make_unique<Mapper65Cart>(bus); } }
};
}  // namespace
}  // namespace fceu11
