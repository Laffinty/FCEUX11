...
# Note: '系' (U+7CFB) and '面' (U+9762) are SHARED between simplified
# and traditional Chinese (used in both scripts as identical forms).
# They were previously in SimplifiedOnly but cause false positives
# on legitimate traditional Chinese text (e.g. '系統' '畫面' '面板').
# Removed in v0.3.15.x PHASE-1 fix.
