...
[![Version](https://img.shields.io/badge/version-v1.15(hotfix1)-blue)](https://github.com/Laffinty/FCEUX11/releases)
...
详见 [CHANGELOG.md](CHANGELOG.md)。当前稳定版为 v1.15(hotfix1)。

See [CHANGELOG.md](CHANGELOG.md). Current stable release is v1.15(hotfix1).
