...
> **编制日期**：2026-08-01
> **编制依据**：
> - `docs/FCEUX11-1.16_最终验收报告.md` §十 R5/R6（原始处方 + 🚨/🚧 实测校准块）
...
> 已回滚（`git checkout`），完整数据见 `docs/history/e1_survey/vbl_step1_1_falsification_2026-08-01.md`。
...
>   非抑制窗口本身。完整数据见 `docs/history/e1_survey/vbl_step1_2_data_2026-08-01.md`。
