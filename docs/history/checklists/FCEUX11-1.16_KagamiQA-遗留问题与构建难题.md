...
> **日期**：2026-07-29
> **分支**：`wip_1.16`
> **关联**：`docs/history/reports/FCEUX11-1.16_KagamiQA-审计报告.md`、`docs/history/reports/FCEUX11-1.16_KagamiQA-修复验证报告.md`
>
> **2026-07-29 勘误说明（Stage-2 PR 0-3）**：
> 本文档三处记载与 `301c742` 之后的 HEAD 实际状态不符，已就地更正：
> 1. §2.4 第 197 行 `2 MiB 全零文件` 表述 — 实测当前 `ppu_rendering_lut_test.exe` 为 10.6 MiB 有效 PE 文件，详见 `docs/history/plans/FCEUX11-1.16_Stage2-构建计划.md` §一勘误 1
