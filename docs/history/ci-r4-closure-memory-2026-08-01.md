...
> 与既有 `docs/history/FCEUX11-1.16_CI-R4-实跑诊断.md`（条目 `ci-r4-diagnosis-2026-07-31` 的等价物）
...
- `docs/history/FCEUX11-1.16_CI-R4-实跑诊断.md` 顶部表格加第三行（`1156ca1` → §七）
- `docs/history/FCEUX11-1.16_CI-R4-实跑诊断.md` §七：本节是新加的第三轮实测记录
