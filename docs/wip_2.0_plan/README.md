...
| 7a | v2.0 Default Switch | ✅ 完成（2026-08-15，commit `868fd83` + tag `v2.0.0`） | `VNESU11_CORE=ON` 默认 + `/FORCE:MULTIPLE` 链接修复 + `VNESU11_SHADOW_RUN` 独立选项 + CI dual-build gate（ON+OFF 双构）。T1 冻结 80.8%（143/177，≥ phase 6 ≥80% 门槛）；85% 门槛推迟到 v2.1（Phase 7b）。**实测**：cargo test 203/0/0 + 187/0/0；blargg T1=80.8%；shadow cpu_match=46/59；mapper_byte_diff 169/175；8/8 CTest 全绿。 | 2-3 周 |
