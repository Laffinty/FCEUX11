...
- `src/attic/pc/dos.c`
- `src/attic/pc/input.h`
- `src/attic/pc/keyscan.h`
- `src/attic/pc/sdl-icon.h`
- `src/attic/pc/sdl-netplay.c`
- `src/attic/pc/sdl-netplay.h`
- `src/attic/pc/sdl-opengl.c`
- `src/attic/pc/sdl-opengl.h`
- `src/attic/pc/sdl-throttle.c`
- `src/attic/pc/sdl-video.h`
- `src/attic/pc/sdl.c`
- `src/attic/pc/sdl.h`
- `src/attic/pc/throttle.c`
- `src/attic/pc/throttle.h`
- `src/attic/pc/unix-netplay.h`
- `src/attic/pc/vgatweak.c`
- `src/attic/sexyal/drivers/dsound.c`
- `src/attic/sexyal/drivers/oss.c`
- `src/attic/sexyal/drivers/oss.h`
- `src/attic/sexyal/drivers/osxcoreaudio.c`
- `src/attic/sexyal/convert.c`
- `src/attic/sexyal/convert.h`
- `src/attic/sexyal/convertgen.c`
- `src/attic/sexyal/md5.h`
- `src/attic/sexyal/sexyal.c`
- `src/attic/sexyal/sexyal.h`
- `src/attic/sexyal/smallc.c`
- `src/attic/sexyal/smallc.h`
- `src/attic/fceustr.cpp`
- `src/attic/fceustr.h`
- `src/attic/soundexp.cpp`
...
- `src/drivers/Qt/unix-netplay.h`
- `src/drivers/sdl/cheat.cpp`
- `src/drivers/sdl/cheat.h`
- `src/drivers/sdl/config.cpp`
- `src/drivers/sdl/config.h`
- `src/drivers/sdl/debugger.cpp`
- `src/drivers/sdl/debugger.h`
- `src/drivers/sdl/dface.h`
- `src/drivers/sdl/fceux_git_info.h`
- `src/drivers/sdl/GamePadConf.cpp`
- `src/drivers/sdl/GamePadConf.h`
- `src/drivers/sdl/glxwin.cpp`
- `src/drivers/sdl/glxwin.h`
- `src/drivers/sdl/input.h`
- `src/drivers/sdl/keyscan.h`
- `src/drivers/sdl/memview.cpp`
- `src/drivers/sdl/memview.h`
- `src/drivers/sdl/ramwatch.cpp`
- `src/drivers/sdl/ramwatch.h`
- `src/drivers/sdl/sdl-icon.h`
- `src/drivers/sdl/sdl-joystick.h`
- `src/drivers/sdl/sdl-netplay.cpp`
- `src/drivers/sdl/sdl-throttle.cpp`
- `src/drivers/sdl/sdl-video.h`
- `src/drivers/sdl/sdl.cpp`
- `src/drivers/sdl/sdl.h`
- `src/drivers/sdl/throttle.h`
- `src/drivers/sdl/unix-netplay.h`
- `src/drivers/videolog/nesvideos-piece.cpp`
- `src/drivers/videolog/nesvideos-piece.h`
- `src/drivers/videolog/quantize.h`
- `src/drivers/videolog/rgbtorgb.cpp`
- `src/drivers/videolog/rgbtorgb.h`
- `src/drivers/videolog/simd.h`
- `src/drivers/win/7zip/IArchive.h`
- `src/drivers/win/7zip/IProgress.h`
- `src/drivers/win/7zip/IStream.h`
- `src/drivers/win/7zip/MyUnknown.h`
- `src/drivers/win/7zip/PropID.h`
- `src/drivers/win/7zip/Types.h`
- `src/drivers/win/directx/x64/ddraw.h`
- `src/drivers/win/directx/x64/dinput.h`
- `src/drivers/win/directx/x64/dsound.h`
- `src/drivers/win/directx/ddraw.h`
- `src/drivers/win/directx/dinput.h`
- `src/drivers/win/directx/dsound.h`
- `src/drivers/win/lua/include/lauxlib.h`
- `src/drivers/win/lua/include/llimits.h`
- `src/drivers/win/lua/include/lmem.h`
- `src/drivers/win/lua/include/lobject.h`
- `src/drivers/win/lua/include/lstate.h`
- `src/drivers/win/lua/include/ltm.h`
- `src/drivers/win/lua/include/lua.h`
- `src/drivers/win/lua/include/luaconf.h`
- `src/drivers/win/lua/include/lualib.h`
- `src/drivers/win/lua/include/lzio.h`
- `src/drivers/win/taseditor/bookmark.cpp`
- `src/drivers/win/taseditor/bookmark.h`
- `src/drivers/win/taseditor/bookmarks.cpp`
- `src/drivers/win/taseditor/bookmarks.h`
- `src/drivers/win/taseditor/branches.cpp`
- `src/drivers/win/taseditor/branches.h`
- `src/drivers/win/taseditor/editor.cpp`
- `src/drivers/win/taseditor/editor.h`
...
- `src/drivers/win/taseditor/inputlog.h`
- `src/drivers/win/taseditor/laglog.cpp`
- `src/drivers/win/taseditor/laglog.h`
- `src/drivers/win/taseditor/markers.cpp`
- `src/drivers/win/taseditor/markers.h`
- `src/drivers/win/taseditor/markers_manager.cpp`
- `src/drivers/win/taseditor/markers_manager.h`
- `src/drivers/win/taseditor/playback.cpp`
- `src/drivers/win/taseditor/playback.h`
- `src/drivers/win/taseditor/popup_display.cpp`
- `src/drivers/win/taseditor/popup_display.h`
- `src/drivers/win/taseditor/recorder.cpp`
- `src/drivers/win/taseditor/recorder.h`
- `src/drivers/win/taseditor/selection.cpp`
- `src/drivers/win/taseditor/selection.h`
- `src/drivers/win/taseditor/snapshot.cpp`
- `src/drivers/win/taseditor/snapshot.h`
- `src/drivers/win/taseditor/splicer.cpp`
- `src/drivers/win/taseditor/splicer.h`
- `src/drivers/win/taseditor/taseditor_config.cpp`
- `src/drivers/win/taseditor/taseditor_config.h`
- `src/drivers/win/taseditor/taseditor_lua.cpp`
- `src/drivers/win/taseditor/taseditor_lua.h`
- `src/drivers/win/taseditor/taseditor_project.cpp`
- `src/drivers/win/taseditor/taseditor_project.h`
- `src/drivers/win/taseditor/taseditor_window.h`
- `src/drivers/win/zlib/adler32.c`
- `src/drivers/win/zlib/compress.c`
- `src/drivers/win/zlib/crc32.c`
- `src/drivers/win/zlib/deflate.c`
- `src/drivers/win/zlib/deflate.h`
- `src/drivers/win/zlib/example.c`
- `src/drivers/win/zlib/gzio.c`
- `src/drivers/win/zlib/infblock.c`
- `src/drivers/win/zlib/infblock.h`
- `src/drivers/win/zlib/infcodes.c`
- `src/drivers/win/zlib/infcodes.h`
- `src/drivers/win/zlib/inffast.c`
- `src/drivers/win/zlib/inffast.h`
- `src/drivers/win/zlib/inffixed.h`
- `src/drivers/win/zlib/inflate.c`
- `src/drivers/win/zlib/inftrees.c`
- `src/drivers/win/zlib/inftrees.h`
- `src/drivers/win/zlib/infutil.c`
- `src/drivers/win/zlib/infutil.h`
- `src/drivers/win/zlib/maketree.c`
- `src/drivers/win/zlib/trees.c`
- `src/drivers/win/zlib/trees.h`
- `src/drivers/win/zlib/uncompr.c`
- `src/drivers/win/zlib/unzip.c`
- `src/drivers/win/zlib/unzip.h`
- `src/drivers/win/zlib/zconf.h`
- `src/drivers/win/zlib/zlib.h`
- `src/drivers/win/zlib/zutil.c`
- `src/drivers/win/zlib/zutil.h`
- `src/drivers/win/afxres.h`
- `src/drivers/win/archive.cpp`
- `src/drivers/win/archive.h`
- `src/drivers/win/args.h`
- `src/drivers/win/aviout.cpp`
- `src/drivers/win/cdlogger.h`
- `src/drivers/win/cheat.h`
- `src/drivers/win/common.cpp`
- `src/drivers/win/common.h`
- `src/drivers/win/config.h`
- `src/drivers/win/debug.h`
- `src/drivers/win/debugger.h`
- `src/drivers/win/directories.cpp`
- `src/drivers/win/directories.h`
- `src/drivers/win/gui.cpp`
- `src/drivers/win/gui.h`
- `src/drivers/win/guiconfig.cpp`
- `src/drivers/win/guiconfig.h`
- `src/drivers/win/header_editor.cpp`
- `src/drivers/win/header_editor.h`
- `src/drivers/win/help.cpp`
- `src/drivers/win/help.h`
- `src/drivers/win/input.h`
- `src/drivers/win/joystick.h`
- `src/drivers/win/keyboard.h`
- `src/drivers/win/log.cpp`
- `src/drivers/win/log.h`
- `src/drivers/win/luaconsole.cpp`
- `src/drivers/win/main.h`
- `src/drivers/win/mapinput.cpp`
- `src/drivers/win/mapinput.h`
- `src/drivers/win/memview.h`
- `src/drivers/win/memwatch.h`
- `src/drivers/win/monitor.cpp`
- `src/drivers/win/monitor.h`
- `src/drivers/win/movieoptions.h`
- `src/drivers/win/netplay.h`
- `src/drivers/win/ntview.h`
- `src/drivers/win/oakra.h`
- `src/drivers/win/OutputDS.cpp`
- `src/drivers/win/palette.cpp`
- `src/drivers/win/palette.h`
- `src/drivers/win/ppuview.h`
- `src/drivers/win/ramwatch.cpp`
- `src/drivers/win/ramwatch.h`
- `src/drivers/win/ram_search.cpp`
- `src/drivers/win/ram_search.h`
- `src/drivers/win/replay.cpp`
- `src/drivers/win/replay.h`
- `src/drivers/win/resource.h`
- `src/drivers/win/sound.h`
- `src/drivers/win/state.cpp`
- `src/drivers/win/state.h`
- `src/drivers/win/taseditor.cpp`
- `src/drivers/win/taseditor.h`
- `src/drivers/win/texthook.h`
- `src/drivers/win/throttle.h`
- `src/drivers/win/timing.cpp`
- `src/drivers/win/timing.h`
- `src/drivers/win/tracer.h`
- `src/drivers/win/video.h`
- `src/drivers/win/wave.h`
- `src/drivers/win/Win32InputBox.cpp`
- `src/drivers/win/Win32InputBox.h`
- `src/drivers/win/window.h`
- `src/fir/c44100ntsc.h`
- `src/fir/c44100pal.h`
- `src/fir/c48000ntsc.h`
- `src/fir/c48000pal.h`
- `src/fir/c96000ntsc.h`
- `src/fir/c96000pal.h`
- `src/fir/toh.c`
...
|------|---------|-----------|
| `src/attic/pc/dface.h` | Unknown/None |  |
| `src/attic/pc/dos-joystick.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-joystick.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-keyboard.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-mouse.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-sound.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-sound.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-video.c` | GPLv2+ | Copyright (C) 1998 \Firebug\; Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos-video.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/dos.c` | Unknown/None |  |
| `src/attic/pc/dos.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/input.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/input.h` | Unknown/None |  |
| `src/attic/pc/keyscan.h` | Unknown/None |  |
| `src/attic/pc/main.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/main.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/sdl-icon.h` | Unknown/None |  |
| `src/attic/pc/sdl-joystick.c` | GPLv2+ | Copyright (C) 2002 Xodnizel; Copyright (C) 2002 Paul Kuliniewicz |
| `src/attic/pc/sdl-netplay.c` | Unknown/None |  |
| `src/attic/pc/sdl-netplay.h` | Unknown/None |  |
| `src/attic/pc/sdl-opengl.c` | Unknown/None |  |
| `src/attic/pc/sdl-opengl.h` | Unknown/None |  |
| `src/attic/pc/sdl-sound.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/sdl-throttle.c` | Unknown/None |  |
| `src/attic/pc/sdl-video.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/sdl-video.h` | Unknown/None |  |
| `src/attic/pc/sdl.c` | Unknown/None |  |
| `src/attic/pc/sdl.h` | Unknown/None |  |
| `src/attic/pc/throttle.c` | Unknown/None |  |
| `src/attic/pc/throttle.h` | Unknown/None |  |
| `src/attic/pc/unix-netplay.c` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/unix-netplay.h` | Unknown/None |  |
| `src/attic/pc/usage.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/attic/pc/vgatweak.c` | Unknown/None |  |
| `src/attic/sexyal/drivers/dsound.c` | Unknown/None |  |
| `src/attic/sexyal/drivers/oss.c` | Unknown/None |  |
| `src/attic/sexyal/drivers/oss.h` | Unknown/None |  |
| `src/attic/sexyal/drivers/osxcoreaudio.c` | Unknown/None |  |
| `src/attic/sexyal/convert.c` | Unknown/None |  |
| `src/attic/sexyal/convert.h` | Unknown/None |  |
| `src/attic/sexyal/convertgen.c` | Unknown/None |  |
| `src/attic/sexyal/md5.c` | GPL |  |
| `src/attic/sexyal/md5.h` | Unknown/None |  |
| `src/attic/sexyal/sexyal.c` | Unknown/None |  |
| `src/attic/sexyal/sexyal.h` | Unknown/None |  |
| `src/attic/sexyal/smallc.c` | Unknown/None |  |
| `src/attic/sexyal/smallc.h` | Unknown/None |  |
| `src/attic/fceustr.cpp` | Unknown/None |  |
| `src/attic/fceustr.h` | Unknown/None |  |
| `src/attic/soundexp.cpp` | Unknown/None |  |
...
| `src/boards/mapinc.h` | Unknown/None |  |
...
| `src/drivers/Qt/TasEditor/TasEditorWindow.h` | GPL |  |
...
| `src/drivers/Qt/nes_shm.cpp` | GPLv2+ | Copyright (C) 2020 mjbudd77 |
| `src/drivers/Qt/nes_shm.h` | Unknown/None |  |
...
| `src/drivers/Qt/unix-netplay.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/Qt/unix-netplay.h` | Unknown/None |  |
| `src/drivers/sdl/cheat.cpp` | Unknown/None |  |
| `src/drivers/sdl/cheat.h` | Unknown/None |  |
| `src/drivers/sdl/config.cpp` | Unknown/None |  |
| `src/drivers/sdl/config.h` | Unknown/None |  |
| `src/drivers/sdl/debugger.cpp` | Unknown/None |  |
| `src/drivers/sdl/debugger.h` | Unknown/None |  |
| `src/drivers/sdl/dface.h` | Unknown/None |  |
| `src/drivers/sdl/fceux_git_info.h` | Unknown/None |  |
| `src/drivers/sdl/GamePadConf.cpp` | Unknown/None |  |
| `src/drivers/sdl/GamePadConf.h` | Unknown/None |  |
| `src/drivers/sdl/glxwin.cpp` | Unknown/None |  |
| `src/drivers/sdl/glxwin.h` | Unknown/None |  |
| `src/drivers/sdl/gui.cpp` | GPL |  |
| `src/drivers/sdl/gui.h` | GPLv2+ |  |
| `src/drivers/sdl/input.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/sdl/input.h` | Unknown/None |  |
| `src/drivers/sdl/keyscan.h` | Unknown/None |  |
| `src/drivers/sdl/main.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/sdl/memview.cpp` | Unknown/None |  |
| `src/drivers/sdl/memview.h` | Unknown/None |  |
| `src/drivers/sdl/ramwatch.cpp` | Unknown/None |  |
| `src/drivers/sdl/ramwatch.h` | Unknown/None |  |
| `src/drivers/sdl/sdl-icon.h` | Unknown/None |  |
| `src/drivers/sdl/sdl-joystick.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel; Copyright (C) 2002 Paul Kuliniewicz |
| `src/drivers/sdl/sdl-joystick.h` | Unknown/None |  |
| `src/drivers/sdl/sdl-netplay.cpp` | Unknown/None |  |
| `src/drivers/sdl/sdl-sound.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/sdl/sdl-throttle.cpp` | Unknown/None |  |
| `src/drivers/sdl/sdl-video.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/sdl/sdl-video.h` | Unknown/None |  |
| `src/drivers/sdl/sdl.cpp` | Unknown/None |  |
| `src/drivers/sdl/sdl.h` | Unknown/None |  |
| `src/drivers/sdl/throttle.h` | Unknown/None |  |
| `src/drivers/sdl/unix-netplay.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/sdl/unix-netplay.h` | Unknown/None |  |
| `src/drivers/videolog/nesvideos-piece.cpp` | Unknown/None |  |
| `src/drivers/videolog/nesvideos-piece.h` | Unknown/None |  |
| `src/drivers/videolog/quantize.h` | Unknown/None | Copyright (C) 1992,2008 Joel Yliluoma (http://iki.fi/bisqwit/) |
| `src/drivers/videolog/rgbtorgb.cpp` | Unknown/None | Copyright (C) 1992,2008 Joel Yliluoma (http://iki.fi/bisqwit/) |
| `src/drivers/videolog/rgbtorgb.h` | Unknown/None | Copyright (C) 1992,2008 Joel Yliluoma (http://iki.fi/bisqwit/) |
| `src/drivers/videolog/simd.h` | Unknown/None | Copyright (C) 1992,2008 Joel Yliluoma (http://iki.fi/bisqwit/) |
| `src/drivers/win/7zip/IArchive.h` | Unknown/None |  |
| `src/drivers/win/7zip/IProgress.h` | Unknown/None |  |
| `src/drivers/win/7zip/IStream.h` | Unknown/None |  |
| `src/drivers/win/7zip/MyUnknown.h` | Unknown/None |  |
| `src/drivers/win/7zip/PropID.h` | Unknown/None |  |
| `src/drivers/win/7zip/Types.h` | Unknown/None |  |
| `src/drivers/win/directx/x64/ddraw.h` | Unknown/None |  |
| `src/drivers/win/directx/x64/dinput.h` | Unknown/None | Copyright (C) 1996-2000 Microsoft Corporation.  All Rights Reserved. |
| `src/drivers/win/directx/x64/dsound.h` | Unknown/None |  |
| `src/drivers/win/directx/ddraw.h` | Unknown/None |  |
| `src/drivers/win/directx/dinput.h` | Unknown/None | Copyright (C) 1996-2000 Microsoft Corporation.  All Rights Reserved. |
| `src/drivers/win/directx/dsound.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lauxlib.h` | Unknown/None |  |
| `src/drivers/win/lua/include/llimits.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lmem.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lobject.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lstate.h` | Unknown/None |  |
| `src/drivers/win/lua/include/ltm.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lua.h` | Unknown/None | Copyright (C) 1994-2008 Lua.org, PUC-Rio"; Copyright (C) 1994-2008 Lua.org, P... |
| `src/drivers/win/lua/include/luaconf.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lualib.h` | Unknown/None |  |
| `src/drivers/win/lua/include/lzio.h` | Unknown/None |  |
| `src/drivers/win/taseditor/bookmark.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/bookmark.h` | Unknown/None |  |
| `src/drivers/win/taseditor/bookmarks.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/bookmarks.h` | Unknown/None |  |
| `src/drivers/win/taseditor/branches.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/branches.h` | Unknown/None |  |
| `src/drivers/win/taseditor/editor.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/editor.h` | Unknown/None |  |
| `src/drivers/win/taseditor/greenzone.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/greenzone.h` | Unknown/None |  |
| `src/drivers/win/taseditor/history.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/history.h` | Unknown/None |  |
| `src/drivers/win/taseditor/inputlog.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/inputlog.h` | Unknown/None |  |
| `src/drivers/win/taseditor/laglog.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/laglog.h` | Unknown/None |  |
| `src/drivers/win/taseditor/markers.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/markers.h` | Unknown/None |  |
| `src/drivers/win/taseditor/markers_manager.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/markers_manager.h` | Unknown/None |  |
| `src/drivers/win/taseditor/piano_roll.cpp` | GPL |  |
| `src/drivers/win/taseditor/piano_roll.h` | GPL |  |
| `src/drivers/win/taseditor/playback.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/playback.h` | Unknown/None |  |
| `src/drivers/win/taseditor/popup_display.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/popup_display.h` | Unknown/None |  |
| `src/drivers/win/taseditor/recorder.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/recorder.h` | Unknown/None |  |
| `src/drivers/win/taseditor/selection.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/selection.h` | Unknown/None |  |
| `src/drivers/win/taseditor/snapshot.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/snapshot.h` | Unknown/None |  |
| `src/drivers/win/taseditor/splicer.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/splicer.h` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_config.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_config.h` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_lua.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_lua.h` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_project.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_project.h` | Unknown/None |  |
| `src/drivers/win/taseditor/taseditor_window.cpp` | GPL |  |
| `src/drivers/win/taseditor/taseditor_window.h` | Unknown/None |  |
| `src/drivers/win/zlib/adler32.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/compress.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/crc32.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/deflate.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/deflate.h` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly |
| `src/drivers/win/zlib/example.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/gzio.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/infblock.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/infblock.h` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/infcodes.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/infcodes.h` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/inffast.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/inffast.h` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/inffixed.h` | Unknown/None |  |
| `src/drivers/win/zlib/inflate.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/inftrees.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/inftrees.h` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/infutil.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/infutil.h` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/maketree.c` | Unknown/None | Copyright (C) 1995-2002 Mark Adler |
| `src/drivers/win/zlib/trees.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly |
| `src/drivers/win/zlib/trees.h` | Unknown/None |  |
| `src/drivers/win/zlib/uncompr.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/unzip.c` | Unknown/None |  |
| `src/drivers/win/zlib/unzip.h` | Unknown/None | Copyright (C) 1998 Gilles Vollant |
| `src/drivers/win/zlib/zconf.h` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/zlib.h` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly and Mark Adler |
| `src/drivers/win/zlib/zutil.c` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/zlib/zutil.h` | Unknown/None | Copyright (C) 1995-2002 Jean-loup Gailly. |
| `src/drivers/win/afxres.h` | Unknown/None |  |
| `src/drivers/win/archive.cpp` | Unknown/None |  |
| `src/drivers/win/archive.h` | Unknown/None |  |
| `src/drivers/win/args.cpp` | GPLv2+ | Copyright (C) 2003 Xodnizel |
| `src/drivers/win/args.h` | Unknown/None |  |
| `src/drivers/win/aviout.cpp` | Unknown/None |  |
| `src/drivers/win/cdlogger.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/cdlogger.h` | Unknown/None |  |
| `src/drivers/win/cheat.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/cheat.h` | Unknown/None |  |
| `src/drivers/win/common.cpp` | Unknown/None |  |
| `src/drivers/win/common.h` | Unknown/None |  |
| `src/drivers/win/config.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/config.h` | Unknown/None |  |
| `src/drivers/win/debug.h` | Unknown/None |  |
| `src/drivers/win/debugger.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/debugger.h` | Unknown/None |  |
| `src/drivers/win/debuggersp.cpp` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/debuggersp.h` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/directories.cpp` | Unknown/None |  |
| `src/drivers/win/directories.h` | Unknown/None |  |
| `src/drivers/win/gui.cpp` | Unknown/None |  |
| `src/drivers/win/gui.h` | Unknown/None |  |
| `src/drivers/win/guiconfig.cpp` | Unknown/None |  |
| `src/drivers/win/guiconfig.h` | Unknown/None |  |
| `src/drivers/win/header_editor.cpp` | Unknown/None |  |
| `src/drivers/win/header_editor.h` | Unknown/None |  |
| `src/drivers/win/help.cpp` | Unknown/None |  |
| `src/drivers/win/help.h` | Unknown/None |  |
| `src/drivers/win/input.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/input.h` | Unknown/None |  |
| `src/drivers/win/joystick.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/joystick.h` | Unknown/None |  |
| `src/drivers/win/keyboard.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/keyboard.h` | Unknown/None |  |
| `src/drivers/win/keyscan.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/log.cpp` | Unknown/None |  |
| `src/drivers/win/log.h` | Unknown/None |  |
| `src/drivers/win/luaconsole.cpp` | Unknown/None |  |
| `src/drivers/win/main.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/main.h` | Unknown/None |  |
| `src/drivers/win/mapinput.cpp` | Unknown/None |  |
| `src/drivers/win/mapinput.h` | Unknown/None |  |
| `src/drivers/win/memview.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/memview.h` | Unknown/None |  |
| `src/drivers/win/memviewsp.cpp` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/memviewsp.h` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/memwatch.cpp` | GPLv2+ | Copyright (C) 2006 Luke Gustafson |
| `src/drivers/win/memwatch.h` | Unknown/None |  |
| `src/drivers/win/monitor.cpp` | Unknown/None |  |
| `src/drivers/win/monitor.h` | Unknown/None |  |
| `src/drivers/win/movieoptions.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/movieoptions.h` | Unknown/None |  |
| `src/drivers/win/netplay.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/netplay.h` | Unknown/None |  |
| `src/drivers/win/ntview.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/ntview.h` | Unknown/None |  |
| `src/drivers/win/oakra.h` | Unknown/None |  |
| `src/drivers/win/OutputDS.cpp` | Unknown/None |  |
| `src/drivers/win/palette.cpp` | Unknown/None |  |
| `src/drivers/win/palette.h` | Unknown/None |  |
| `src/drivers/win/ppuview.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/ppuview.h` | Unknown/None |  |
| `src/drivers/win/pref.cpp` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/pref.h` | GPLv2+ | Copyright (C) 2005 Sebastian Porst |
| `src/drivers/win/ramwatch.cpp` | Unknown/None |  |
| `src/drivers/win/ramwatch.h` | Unknown/None |  |
| `src/drivers/win/ram_search.cpp` | Unknown/None |  |
| `src/drivers/win/ram_search.h` | Unknown/None |  |
| `src/drivers/win/replay.cpp` | Unknown/None |  |
| `src/drivers/win/replay.h` | Unknown/None |  |
| `src/drivers/win/resource.h` | Unknown/None |  |
| `src/drivers/win/sound.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel and zeromus |
| `src/drivers/win/sound.h` | Unknown/None |  |
| `src/drivers/win/state.cpp` | Unknown/None |  |
| `src/drivers/win/state.h` | Unknown/None |  |
| `src/drivers/win/taseditor.cpp` | Unknown/None |  |
| `src/drivers/win/taseditor.h` | Unknown/None |  |
| `src/drivers/win/texthook.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/texthook.h` | Unknown/None |  |
| `src/drivers/win/throttle.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/throttle.h` | Unknown/None |  |
| `src/drivers/win/timing.cpp` | Unknown/None |  |
| `src/drivers/win/timing.h` | Unknown/None |  |
| `src/drivers/win/tracer.cpp` | GPLv2+ | Copyright (C) 2002 Ben Parnell |
| `src/drivers/win/tracer.h` | Unknown/None |  |
| `src/drivers/win/video.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/video.h` | Unknown/None |  |
| `src/drivers/win/wave.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/wave.h` | Unknown/None |  |
| `src/drivers/win/Win32InputBox.cpp` | Unknown/None |  |
| `src/drivers/win/Win32InputBox.h` | Unknown/None |  |
| `src/drivers/win/window.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/drivers/win/window.h` | Unknown/None |  |
| `src/fir/c44100ntsc.h` | Unknown/None |  |
| `src/fir/c44100pal.h` | Unknown/None |  |
| `src/fir/c48000ntsc.h` | Unknown/None |  |
| `src/fir/c48000pal.h` | Unknown/None |  |
| `src/fir/c96000ntsc.h` | Unknown/None |  |
| `src/fir/c96000pal.h` | Unknown/None |  |
| `src/fir/toh.c` | Unknown/None |  |
...
| `src/lua/src/lapi.c` | Unknown/None |  |
| `src/lua/src/lapi.h` | Unknown/None |  |
| `src/lua/src/lauxlib.c` | Unknown/None |  |
| `src/lua/src/lauxlib.h` | Unknown/None |  |
| `src/lua/src/lbaselib.c` | Unknown/None |  |
| `src/lua/src/lcode.c` | Unknown/None |  |
| `src/lua/src/lcode.h` | Unknown/None |  |
| `src/lua/src/ldblib.c` | Unknown/None |  |
| `src/lua/src/ldebug.c` | Unknown/None |  |
| `src/lua/src/ldebug.h` | Unknown/None |  |
| `src/lua/src/ldo.c` | Unknown/None |  |
| `src/lua/src/ldo.h` | Unknown/None |  |
| `src/lua/src/ldump.c` | Unknown/None |  |
| `src/lua/src/lfunc.c` | Unknown/None |  |
| `src/lua/src/lfunc.h` | Unknown/None |  |
| `src/lua/src/lgc.c` | Unknown/None |  |
| `src/lua/src/lgc.h` | Unknown/None |  |
| `src/lua/src/linit.c` | Unknown/None |  |
| `src/lua/src/liolib.c` | Unknown/None |  |
| `src/lua/src/llex.c` | Unknown/None |  |
| `src/lua/src/llex.h` | Unknown/None |  |
| `src/lua/src/llimits.h` | Unknown/None |  |
| `src/lua/src/lmathlib.c` | Unknown/None |  |
| `src/lua/src/lmem.c` | Unknown/None |  |
| `src/lua/src/lmem.h` | Unknown/None |  |
| `src/lua/src/loadlib.c` | Unknown/None |  |
| `src/lua/src/lobject.c` | Unknown/None |  |
| `src/lua/src/lobject.h` | Unknown/None |  |
| `src/lua/src/lopcodes.c` | Unknown/None |  |
| `src/lua/src/lopcodes.h` | Unknown/None |  |
| `src/lua/src/loslib.c` | Unknown/None |  |
| `src/lua/src/lparser.c` | Unknown/None |  |
| `src/lua/src/lparser.h` | Unknown/None |  |
| `src/lua/src/lstate.c` | Unknown/None |  |
| `src/lua/src/lstate.h` | Unknown/None |  |
| `src/lua/src/lstring.c` | Unknown/None |  |
| `src/lua/src/lstring.h` | Unknown/None |  |
| `src/lua/src/lstrlib.c` | Unknown/None |  |
| `src/lua/src/ltable.c` | Unknown/None |  |
| `src/lua/src/ltable.h` | Unknown/None |  |
| `src/lua/src/ltablib.c` | Unknown/None |  |
| `src/lua/src/ltm.c` | Unknown/None |  |
| `src/lua/src/ltm.h` | Unknown/None |  |
| `src/lua/src/lua.c` | Unknown/None |  |
| `src/lua/src/lua.h` | Unknown/None | Copyright (C) 1994-2008 Lua.org, PUC-Rio"; Copyright (C) 1994-2008 Lua.org, P... |
| `src/lua/src/luac.c` | Unknown/None |  |
| `src/lua/src/luaconf.h` | Unknown/None |  |
| `src/lua/src/lualib.h` | Unknown/None |  |
| `src/lua/src/lundump.c` | Unknown/None |  |
| `src/lua/src/lundump.h` | Unknown/None |  |
| `src/lua/src/lvm.c` | Unknown/None |  |
| `src/lua/src/lvm.h` | Unknown/None |  |
| `src/lua/src/lzio.c` | Unknown/None |  |
| `src/lua/src/lzio.h` | Unknown/None |  |
| `src/lua/src/print.c` | Unknown/None |  |
...
| `src/utils/ioapi.cpp` | Unknown/None | Copyright (C) 1998-2010 Gilles Vollant (minizip) ( http://www.winimage.com/zL... |
| `src/utils/ioapi.h` | Unknown/None | Copyright (C) 1998-2010 Gilles Vollant (minizip) ( http://www.winimage.com/zL... |
| `src/utils/md5.cpp` | GPL |  |
...
| `src/utils/unzip.cpp` | Unknown/None | Copyright (C) 1998-2010 Gilles Vollant (minizip) ( http://www.winimage.com/zL... |
| `src/utils/unzip.h` | Unknown/None | Copyright (C) 1998-2010 Gilles Vollant (minizip) ( http://www.winimage.com/zL... |
...
| `src/driver.h` | Unknown/None |  |
| `src/emufile.cpp` | Unknown/None | Copyright (C) 2009-2010 DeSmuME team |
...
| `src/ines.cpp` | GPLv2+ | Copyright (C) 1998 BERO; Copyright (C) 2002 Xodnizel |
...
| `src/ld65dbg.cpp` | Unknown/None |  |
| `src/ld65dbg.h` | Unknown/None |  |
| `src/lua-engine.cpp` | GPL | Copyright (C) 2008-2009 Mike Pall. All rights reserved. |
...
| `src/types-des.h` | GPLv2+ | Copyright (C) 2005 Guillaume Duhamel; Copyright (C) 2008-2009 DeSmuME team |
| `src/types.h` | GPLv2+ | Copyright (C) 2001 Aaron Oneal; Copyright (C) 2002 Xodnizel |
| `src/unif.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/unif.h` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/version.h` | GPLv2+ | Copyright (C) 2001 Aaron Oneal; Copyright (C) 2002 Xodnizel |
| `src/video.cpp` | GPLv2+ | Copyright (C) 2002 Xodnizel |
| `src/video.h` | Unknown/None |  |
| `src/vsuni.cpp` | GPLv2+ | Copyright (C) 2003 Xodnizel |
